...
namespace Dispatching.Rides
{
    public class Ride : Entity<Ride>
    {
        ...
        public void Start(DateTime whenTheRideStarts)
        {
            ...
            if (Stopped.HasValue && Stopped.Value <= whenTheRideStarts)
            {
                throw new ArgumentException("The ride cannot start after it has ended.", nameof(whenTheRideStarts));
            }
        ...
        public void Stop(DateTime whenTheRideStops)
        {
            ...
            {
                throw new ArgumentException("A ride cannot end earlier than it started.", nameof(whenTheRideStops));
            }
